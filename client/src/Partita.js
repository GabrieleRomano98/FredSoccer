...
function Partita(props) {
    ...
    const deleteF = (Id, s) => {id = Id; idSquadra = partita[s].id; selectAction("Elimina Informazioni");};
    ...
    return( !partita ? <div align="center"><Spinner animation="border" /></div> :
        <Container className="justify-content-center">
            ...
            />
            {!!props.logged && <Row inline className="justify-content-center"> 
